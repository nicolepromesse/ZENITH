...
<html lang="en">
  ...
  <head>
    ...
    <meta
      name="keywords"
      content="ABA, mental health, speech therapy, autism, special needs, therapy, Rwanda"
    />
    <!--<< Favcion >>-->
  ...
  <body>
    ...
    <section class="bannerv2-section position-relative fix" id="scrollUp">
          ...
          <div class="col-lg-6 col-md-9">
            <div class="herov2-content position-relative">
              ...
              <p
                ...
                data-wow-delay=".5s"
                style="font-weight: bolder; color: aliceblue"
              >
              ...
              <!-- Element -->
              <img
                src="assets/img/abanner/reg.png"
                alt="img"
      ...
      <!-- Element -->
      <img src="assets/img/abanner/kyte.png" alt="img" class="banner-kyte" />
      <img
        src="assets/img/new/home1.webp"
        alt="img"
        class="banner-shape wow fadeInLeft"
        data-wow-delay=".3s"
      />
      <img
        src="assets/img/abanner/banner-shadow.png"
        alt="img"
        class="banner-shadow"
      />
    </section>
