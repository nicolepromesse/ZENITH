          ...
          <ul>
            ...
            <li class="d-flex align-items-center">
              ...
              <div class="offcanvas__contact-text">
                <a href="mailto:info@zenith-rw.com" target="_blank"><span
                    class="mailto:info@zenith-rw.com">info@zenith-rw.com</span></a>
              </div>
            </li>
...
<header id="header-sticky" class="header-1 white-bg">
  ...
  height: 80px;
">
            <a href="index.php" class="header-logo" style="display: block; width: 100%; height: 100%;"></a>
          </div>
